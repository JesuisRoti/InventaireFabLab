...
urlpatterns = [
    ...
    re_path(r'^login_supprimer/(?P<project_name>.+)/(?P<id>.+)', views.check_login_supprimer,
            name="login_supprimer"),
    path('supprimer_project_reservation/<str:project_Name>/<int:id>', views.supprimer_project_reservation, name="supprimer_project_reservation"),
